...
fun AttendanceCard(
    ...
    // Use status directly, remove local colorState
    Card(
        ...
        Column(
            ...
            Row(
                ...
                AttendanceButton(status, "Present") { onStatusChange(it) }
            }
            Row(
                modifier = Modifier
                    .fillMaxWidth()
                ...
                AttendanceButton(status, "HalfDay") { onStatusChange(it) }
                AttendanceButton(status, "Leave") { onStatusChange(it) }
                AttendanceButton(status, "Absent") { onStatusChange(it) }
            }
        }
    }
}
